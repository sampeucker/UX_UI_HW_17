  ...
  var Intense = (function() {
    ...
    function createViewer(title, caption) {
      ...
      var captionContainerProperties = {
        fontFamily: '"HelviticaNeue-Medium", "Helvetica Neue Medium", "HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif',
        position: "fixed",
        bottom: "0px",
        left: "0px",
        padding: "20px",
